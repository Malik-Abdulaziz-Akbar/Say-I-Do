...
public class DecorsAdapter extends ArrayAdapter <DecorOptions>{
    Context context;
    ArrayList<DecorOptions> selectedOptions = new ArrayList<DecorOptions>();
    public DecorsAdapter(@NonNull Context context, ArrayList<DecorOptions> optionsArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final DecorOptions CurrentOption = getItem(position);
...
// when you click this demo button
    ...
    public ArrayList<DecorOptions> getSelectedOptions() {
